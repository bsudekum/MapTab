...
},{"./modal":158,"react":155}],158:[function(require,module,exports){
var React = require('react');
...
var Modal = React.createClass({displayName: "Modal",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "modal pad4 fill-white keyline-all round", id: "settings"}, 
        React.createElement("a", {href: "#", className: "pin-right icon close pad1 row1 quiet", id: "close"}), 
        React.createElement("h3", {className: "space-bottom2"}, "Settings"), 
        React.createElement("form", {id: "form-settings", onSubmit: this.handleSubmit}, 
          React.createElement("fieldset", null, 
            React.createElement("label", null, "Initial Position"), 
            React.createElement("div", {className: "radio-pill pill clearfix col12"}, 
              React.createElement("input", {type: "radio", className: "stroked", name: "loc", value: "userLoc", id: "userLoc", checked: this.state.userLoc}), 
              React.createElement("label", {htmlFor: "userLoc", className: "col4 button icon check"}, "User location"), 
              React.createElement("input", {type: "radio", name: "loc", className: "stroked", value: "lastPos", id: "lastPos", checked: this.state.lastPos}), 
              React.createElement("label", {htmlFor: "lastPos", className: "col4 button icon check"}, "Last Position"), 
              React.createElement("input", {type: "radio", name: "loc", value: "random", id: "random", checked: this.state.random}), 
              React.createElement("label", {htmlFor: "random", className: "col4 button icon check"}, "Random")
            )
          ), 
          React.createElement("fieldset", null, 
            React.createElement("label", null, "Map Type"), 
            React.createElement("div", {id: "layers", className: "radio-pill pill clearfix col12"}, 
              React.createElement("input", {type: "radio", ref: "sat", name: "map", value: "sat", id: "sat"}), 
              React.createElement("label", {htmlFor: "sat", className: "col3 button icon check"}, "Satellite"), 
              React.createElement("input", {type: "radio", ref: "streets", name: "map", value: "streets", id: "streets"}), 
              React.createElement("label", {htmlFor: "streets", className: "col3 button icon check"}, "Streets"), 
              React.createElement("input", {type: "radio", ref: "random-map", name: "map", value: "random-map", id: "random-map"}), 
              React.createElement("label", {htmlFor: "random-map", className: "col3 button icon check"}, "Random"), 
              React.createElement("input", {type: "radio", ref: "custom", name: "map", value: "custom", id: "custom"}), 
              React.createElement("label", {htmlFor: "custom", className: "col3 button icon check"}, "Custom")
            )
          ), 
          React.createElement("fieldset", null, 
            React.createElement("label", {htmlFor: "custom-mapid", className: "quiet"}, "Custom ", React.createElement("a", {href: "https://mapbox.com", target: "_blank"}, "Mapbox"), " mapid or ", React.createElement("a", {id: "save-current", href: "#"}, "save current")
            ), 
            React.createElement("input", {type: "text", value: "", className: "col6", name: "custom-mapid", id: "custom-mapid", disabled: true, placeholder: "Enable 'Custom' to edit"})
          ), 
          React.createElement("input", {type: "submit", className: "fl", value: "Save Changes", name: "", id: "save"}), 
          React.createElement("span", {className: "fr micro quiet pad1y icon mail"}, 
            React.createElement("a", {href: "https://chrome.google.com/webstore/detail/maptab/dmabflbokojjfjicmbjjfnmodihciemo", className: "quiet space-right1", target: "_blank"}, "Share"), 
            React.createElement("a", {href: "https://github.com/bsudekum/MapTab", target: "_blank", className: "icon github quiet"}, "Fork")
          )
        )
      )
    );
...
},{"./util":159,"react":155}],159:[function(require,module,exports){
module.exports = {
    setCookie: setCookie,
    getCookie: getCookie
}
