...
var UI = React.createClass({
  ...
  componentDidMount: function() {
    ...
    util.getCookie('settings', function (settings) {
      var displayTime = settings && settings.timeDisplaySettings[0].checked;
      self.setState({ displayTime: displayTime });
    })
  },
  ...
  render: function() {
    ...
    return (
      <div>
        ...
        <Map onGeocode={this.handleGeocode} randomMapId={mapids[index].id} />
        <Modal randomMapId={mapids[index].id} />
      </div>
    )
  }
