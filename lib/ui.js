...
var UI = React.createClass({
  ...
  handleMapMove(lat,lng) {
    ...
    this.refs.globe.updateGlobeRotation(lng, lat);
  },
  ...
  render: function() {
    return (
      <div>
        ...
        <Map onMoveEnd={this.handleMapMove} onGeocode={this.handleGeocode} randomMapId={this.state.mapid} />
        <Globe ref="globe" location={this.state.location} />
