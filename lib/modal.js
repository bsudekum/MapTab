    ...
    return (
      <div className='modal pad4 fill-white keyline-all round' id='settings'>
        ...
        <form id='form-settings' onSubmit={this.handleSubmit}>
          ...
          <fieldset>
            <div className="col6 clearfix">
              <label htmlFor='custom-mapid' className='quiet'>Custom <a href='https://mapbox.com' target='_blank'>Mapbox</a> mapid</label>
              <input type='text' value={this.state.customMapId} onChange={this.handleCustomChange} onClick={this.handleOnClick} placeholder='Custom Map ID' />
            </div>
            <div className='col6 checkbox-pill clearfix' id='globe-checkbox-div'>
              <input type='checkbox' id='globe-checkbox' checked={this.state.showGlobe} onChange={this.handleShowGlobeChange} />
              <label htmlFor='globe-checkbox' className={'button icon fr' + (this.state.showGlobe ? ' check' : '')}>Show globe?</label>
            </div>
          </fieldset>
